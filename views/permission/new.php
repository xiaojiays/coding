    ...
    <div class="col-lg-12">
        <div class="panel panel-default toggle" id="spr_0">
            ...
            <div class="panel-body">
                ...
                <form method="post" action="/permission/create" class="form-horizontal group-border hover-stripped" role="form">
                    <input name="_csrf" type="hidden" id="_csrf" value="<?= Yii::$app->request->csrfToken ?>">
                    <div class="form-group">
                        <label class="col-lg-2 col-md-2 col-sm-12 control-label">权限名称</label>
                        <div class="col-lg-10 col-md-10">
                        <input name="name" type="text" value="<?=$name?>" class="form-control" style="width:300px;" autofocus="autofocus">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-2 col-md-2 col-sm-12 control-label">权限描述</label>
                        <div class="col-lg-10 col-md-10">
                        <input name="desc" type="text" value="<?=$desc?>" class="form-control" style="width:300px;" autofocus="autofocus">
                        </div>
                    </div>
                    <div class="form-group">
