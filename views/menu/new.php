    ...
    <div class="col-lg-12">
        <div class="panel panel-default toggle" id="spr_0">
            ...
            <div class="panel-body">
                <form method="post" action="/menu/create" class="form-horizontal group-border hover-stripped" role="form" enctype="multipart/form-data"">
